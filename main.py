...
def main(dist, num_sim, num_exp, T_total):
    ...
    filters = ['finite', 'inf', 'drkf_inf', 'drkf_finite', 'bcot', 'risk']
    filter_labels = {
    ...
    header = "{:<35} {:<35} {:<35} {:<15}".format("Method", "LQR Cost", "Average MSE", "Best theta")
    print(header)
    print("-"*120)
    for filt in filters:
        ...
        print("{:<35} {:<35} {:<35} {:<15}".format(filter_labels[filt], cost_str, mse_str, best_theta))
