...
This script creates 3D surface plots from the results of main6.py:
1. 3D surface plot showing regret MSE as a function of theta_w and theta_v
2. 2D contour plot for better visualization of the regret landscape

Usage:
    python plot6.py --dist normal
    python plot6.py --dist quadratic
    python plot6.py --dist laplace
"""
...
def create_3d_surface_plot(regret_data, dist):
    """Create 3D surface plot of average regret MSE vs theta_w and theta_v"""
    
    # Extract and organize data using pandas for easier handling
    ...
    ax.set_ylabel(r'$\theta_v$', fontsize=20)
    ax.zaxis.set_rotate_label(False)  # Rotate z-axis label opposite
    ax.set_zlabel('Average Regret MSE', fontsize=20, labelpad=15, rotation=90)
    
    # Move z-axis tick labels further from axis
