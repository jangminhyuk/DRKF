...
Scalability experiment testing computation time of drkf_inf with respect to system dimension.

Usage:
    python main6_time.py
"""
...
def generate_stable_system(n):
    """Generate a stable system of dimension n with proper detectability"""
    
    # Both A and C matrices should have same dimension n
    ny = n  # C matrix is now n×n
