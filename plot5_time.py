...
This script creates computation time comparison plots from the results of main5_time.py.
Shows execution time vs time horizon for different DRKF methods.
...
# Set larger font sizes for better readability (matching plot5_1.py)
plt.rcParams.update({
...
def get_color_for_filter(filt, i):
    """Define consistent color mapping for all plots (matching plot5_1.py)"""
...
def create_computation_time_plot():
    ...
    # Legend
    legend = ax.legend(bbox_to_anchor=(0.5, -0.08), loc='upper center', ncol=2)
