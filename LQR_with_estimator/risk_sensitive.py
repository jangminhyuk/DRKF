...
class RiskSensitive:
    def __init__(self, T, dist, noise_dist, system_data, B,
        ...
        self.nominal_Sigma_v = nominal_Sigma_v                 # EM estimate for measurement noise covariance
    ...
    def forward(self):
        ...
        R = self.nominal_Sigma_v        # measurement noise covariance (EM estimate)
    ...
    def forward_track(self, desired_trajectory):
        ...
        R = self.nominal_Sigma_v        # EM estimate for measurement noise covariance.
        theta_rs = self.theta_rs
