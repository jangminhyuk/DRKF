...
# -*- coding: utf-8 -*-
"""
DRKF_ours_finite.py implements a distributionally robust Kalman filter (DRKF) for state estimation
...
class DRKF_ours_finite(BaseFilter):
    ...
    # --- SDP Formulation and Solver for Worst-Case State and Measurement noise Covariance ---
